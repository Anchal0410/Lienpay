...
app.use(cors({
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'x-device-id', 'x-device-os', 'x-app-version', 'x-admin-token', 'x-lender-token', 'x-nbfc-api-key', 'x-webhook-secret'],
}));
app.use(compression());
...
// NBFC programmatic API (machine-to-machine, auth: x-nbfc-api-key)
